/*
 * clock.ino — standalone Flip Clock (dot-matrix departure-board look)
 *
 * Waveshare ESP32-S3-Touch-AMOLED-1.8
 * NTP-synced time over WiFi. Reads SSID/PASSWORD/TIMEZONE/CLOCK_COLOR
...
void setup() {
  ...
  // Read brightness/timeout. app_flipclock re-mounts SD for SSID/TIMEZONE/etc.
